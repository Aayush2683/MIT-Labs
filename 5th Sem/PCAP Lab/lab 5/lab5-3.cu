//Convolution operation on one dimentional input arrayN of size width using mask array M of size mask_width to 
//produce the resultant one dimentional array P of size width
